...
Na última aula, modelamos juntos um site de compra de passagens aéreas com dois atores: **compradores** e **companhias**. Hoje, vamos trabalhar do ponto de vista das **companhias**.
...
O menu já está montado para você. O seu trabalho é implementar toda a lógica das classes e dos métodos.

⚠️ **Atenção:** Os nomes das classes e métodos devem ser mantidos exatamente como estão na estrutura abaixo.
